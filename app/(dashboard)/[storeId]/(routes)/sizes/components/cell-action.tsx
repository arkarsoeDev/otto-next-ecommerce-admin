...
import { deleteSize } from "@/actions/owner/size";
...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    const onDelete = async () => {
        try {
            ...
            await deleteSize({
                data: { id: data.id },
                redirectPath: routePath.sizes(params.storeId),
                revalidateTags: [routeTags.getSizes()]
            })
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => router.push(routePath.updateSize(params.storeId, data.id))}>
